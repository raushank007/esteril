...
export default async function AboutPage() {
  ...
  // Fallback defaults in case the file goes missing
      ...
      <section className="max-w-7xl mx-auto px-6 py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            {/* Map over the paragraphs extracted from the markdown body */}
            {paragraphs.map((p, index) => (
              <p key={index} className="text-slate-600 mb-6 leading-relaxed text-lg">
                {p}
              </p>
            ))}
